...
import TaskSocraticObject from 'app/orgs/[orgslug]/dash/assignments/[assignmentuuid]/_components/TaskEditor/Subs/TaskTypes/TaskSocraticObject'
        ...
        return (
          <div className='flex flex-col space-y-2' key={task.assignment_task_uuid}>
            ...
            <div className='w-full'>
              ...
              {task.assignment_type === 'SOCRATIC_PROBLEM' && <TaskSocraticObject key={task.assignment_task_uuid} view='student' assignmentTaskUUID={task.assignment_task_uuid} />}
            </div>
          </div>
        )
      })}
