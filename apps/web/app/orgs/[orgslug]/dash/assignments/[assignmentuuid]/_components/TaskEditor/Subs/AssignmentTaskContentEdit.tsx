...
import TaskSocraticObject from './TaskTypes/TaskSocraticObject';
...
function AssignmentTaskContentEdit() {
    ...
    return (
        <div>
            ...
            {assignment_task?.assignmentTask.assignment_type === 'SOCRATIC_PROBLEM' && <TaskSocraticObject view='teacher' assignmentTaskUUID={assignment_task?.assignmentTask.assignment_task_uuid} />}
        </div>
    )
}
